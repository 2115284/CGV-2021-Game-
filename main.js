...
init = function () {
    ...
    let urls = [
        "img/HeartInTheSand/posx.jpg","img/HeartInTheSand/negx.jpg",
        "img/HeartInTheSand/posy.jpg","img/HeartInTheSand/negy.jpg",
        "img/HeartInTheSand/posz.jpg","img/HeartInTheSand/negz.jpg"
    ];
    let loaderz = new THREE.CubeTextureLoader();
    scene.background = loaderz.load(urls);
